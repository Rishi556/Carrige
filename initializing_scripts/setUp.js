...
connection.connect((err) => {
    ...
    sql += `CREATE TABLE deleted_comments (Permlink INT AUTO_INCREMENT PRIMARY KEY,ParentID INT, AuthorID INT, Title VARCHAR(255), Body VARCHAR(255), Metadata JSON, PostTime INT);`
