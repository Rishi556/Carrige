...
connection.connect((err) => {
    ...
    sql += `CREATE TABLE comments (Permlink INT AUTO_INCREMENT PRIMARY KEY,ParentID INT, AuthorID INT, Title VARCHAR(20000), Body VARCHAR(20000), Metadata JSON, PostTime INT);`
