...
connection.connect((err) => {
    ...
    sql += `CREATE TABLE comments (PostID INT AUTO_INCREMENT PRIMARY KEY, Author INT, Title VARCHAR(255), Body VARCHAR(255), Metadata JSON, ParentID INT);`
    sql += `CREATE TABLE votes (PostID INT, Voter INT, VoteValue INT);`
